...
<link
	...
	rel="stylesheet"
	integrity="sha384Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi"
...
<body>
	...
	<br>
	<button id="btn7">/ex43/sub08 post 요청 #form2에 있는 데이터 활용</button>
	...
	<script>
		...
		document.querySelector("#btn7").addEventListener(
				"click",
				function() {
		...
		document.querySelector("#btn4").addEventListener(
				"click",
				function() {
					const data = new URLSearchParams(new FormData(
		...
		document.querySelector("#btn2").addEventListener("click", function() {
			fetch(ctx + "/ex43/sub02?email=abc@gmail.com&age=33");
		});
